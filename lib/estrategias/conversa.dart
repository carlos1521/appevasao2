...
class Conversa extends StatefulWidget {
  Conversa(this.idaluno);
  String idaluno;

  @override
  _ConversaState createState() => new _ConversaState();
}
...
class _ConversaState extends State<Conversa> {
  ...
  void addData() {
    var url = "http://apiuladech.grupodcv.com/addestrategia2.php";
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text( "Cadastrar Conversa com Aluno" ),
