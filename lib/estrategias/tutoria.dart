...
class Tutoria extends StatefulWidget {
  Tutoria(this.idaluno);
  String idaluno;

  @override
  _TutoriaState createState() => new _TutoriaState();
}

class _TutoriaState extends State<Tutoria> {
  ...
  void addData() {
    var url = "http://apiuladech.grupodcv.com/addestrategia4.php";
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text( "Cadastrar Tutoría" ),
